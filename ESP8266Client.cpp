...
size_t ESP8266Client::println(const __FlashStringHelper *buffer)
{
    ESP8266CommandStatus status = _esp8266->send(_id, buffer, true);
    ...
    return _esp8266->strlen_F(buffer) + 2;
}
